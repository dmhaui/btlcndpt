...
public class PlayerInput : MonoBehaviour{
    ...
    private void yMovement() {
        ...
        if (Input.GetButtonDown("Jump") && hasDoubleJump && !isGrounded){
            ...
            //hasDoubleJump = false; cmt lại để nhảy dược nhiêuf, sửa cả trên kia nữa
    ...
    private void cast() {
        // summon sword
        if (Input.GetButtonDown("Fire3") && (controller.GetCurrentAnimatorStateInfo(0).IsName("Idle") || controller.GetCurrentAnimatorStateInfo(0).IsName("Walk")
            || controller.GetCurrentAnimatorStateInfo(0).IsName("Rising") || controller.GetCurrentAnimatorStateInfo(0).IsName("Falling") || controller.GetCurrentAnimatorStateInfo(0).IsName("DoubleJump"))
            && !swordExists) {
    ...
    public void startTeleport() {
        ...
        if (swords[0] != null) {
            ...
            int boostRadius = 40; //minimum distance away from sword to get a movement boost / khoảng cách teleport
